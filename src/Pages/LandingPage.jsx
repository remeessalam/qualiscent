  ...
  return (
    <>
      {isWeb ? (
        <Helmet>
          <title>
            Affordable Web Development Services Gujarat | Small Business
            Websites
          </title>
          <meta
            name="description"
            content="Professional web development for small businesses in Gujarat. Custom websites, e-commerce solutions, responsive design. Budget-friendly packages. Free consultation available."
          />
        </Helmet>
      ) : (
        <Helmet>
          <title>
            Mobile App Development Services Gujarat | Affordable Apps for SMBs
          </title>
          <meta
            name="description"
            content="Custom mobile app development for small businesses in Gujarat. Android, iOS, and cross-platform apps. Affordable development packages. Transform your business digitally."
          />
        </Helmet>
      )}
          ...
          <div className="pt-[8rem] md:pt-[8rem] pb-[4rem]">
            ...
            >
              <p className="section-heading">
                Welcome to Qualiscent Infotech LLP
              </p>
        ...
        <div className="pt-[2rem] wrapper flex flex-col-reverse md:grid grid-cols-[auto_55%] gap-7">
          ...
          <div data-aos="fade-up">
            ...
            <p className="mt-5">
              ...
              information about your project or needs. Share any specific goals
              or challenges you’re facing, and we’ll tailor the consultation to
        ...
        <section id="about" className="pt-[5rem]">
          <div className="wrapper grid md:grid-cols-2 gap-7">
            <div data-aos="fade-up" className="space-y-4">
              ...
              <p>
                {isWeb
                  ? "At Qualiscent Infotech LLP , we specialize in creating high-performance, user-centric websites that deliver exceptional results. From conceptualization to deployment, our expert team provides innovative web development solutions that empower businesses to expand their digital presence, engage customers, and drive growth."
                  : "Qualiscent Infotech LLP  offers comprehensive mobile app development services that deliver tailored, seamless, and intuitive solutions. From ideation to launch, we create innovative mobile apps that empower businesses to enhance user experiences, drive engagement, and scale globally."}
              </p>
            ...
            <div data-aos="fade-up" className="flex flex-col gap-7">
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    ...
                    solutions, trusted by businesses worldwide for our
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    With a proven track record of success, Qualiscent Infotech
                    LLP has been honored with multiple industry awards for
