...
export const servicessss = [
  {
    ...
    icon: icon1,
    desc: "Transform your business with Qualiscent Infotech LLP's tailored AI development solutions. From automating processes to delivering actionable insights, we help you innovate, scale, and stay ahead in a dynamic digital world.",
    detailsPage: {
   ...
   <div class="space-y-4">
    ...
    <p class="">
      At <span class="font-bold text-secondary">Qualiscent Infotech LLP</span>, we specialize in crafting tailored AI solutions that enable organizations to unlock the full potential of AI and stay ahead of the curve.
    </p>
   </div>
  </div>`,
...
`,
  ...
  <div class="space-y-6">
    ...
    <p>
      At Qualiscent Infotech LLP, we understand that every business is unique. That’s why we offer customized AI solutions designed to meet your specific needs and goals.
    </p>
...
`,
  ...
  },
  {
    ...
    icon: icon2,
    desc: "Elevate your online presence with Qualiscent Infotech LLP’s cutting-edge web development services. We craft responsive, user-centric websites that drive engagement, enhance functionality, and fuel business growth.",
    detailsPage: {
  ...
  <div class="space-y-4">
    ...
    <p>
      At <span class="font-bold text-secondary">Qualiscent Infotech LLP</span>, we specialize in creating custom, responsive websites that deliver a seamless user experience, enhance functionality, and fuel your growth.
    </p>
  </div>
</div>
`,
  ...
  <div class="space-y-6">
    <h2 class="text-xl font-bold">
      Why Choose Qualiscent Infotech LLP for Web Development?
    </h2>
    <ul class="space-y-5 list-decimal pl-6">
      <li>
...
`,
  ...
  },
  {
    ...
    icon: icon3,
    desc: "Take your business to the next level with Qualiscent Infotech LLP’s innovative app development services. We design and develop mobile applications that deliver seamless experiences, enhance user engagement, and drive growth.",
    detailsPage: {
      ...
      firstSection: `<div class="space-y-6">
        <div class="space-y-4">
          ...
          <p>
            At <span class="font-bold text-secondary">Qualiscent Infotech LLP</span>, we specialize in developing high-quality mobile applications that provide an exceptional user experience, enhance functionality, and grow your business.
          </p>
        </div>
      </div>
      `,
      secondSection: `<div class="py-6">
        <div class="space-y-6">
          <h2 class="text-xl font-bold">
            Why Choose Qualiscent Infotech LLP for App Development?
          </h2>
          <ul class="space-y-5 list-decimal pl-6">
            <li>
  ...
  },
  {
    ...
    icon: icon4,
    desc: "Empower your business with Qualiscent Infotech LLP’s custom software development solutions. We design scalable, high-performance software tailored to streamline operations and drive growth.",
    detailsPage: {
      ...
      firstSection: `<div class="space-y-6">
        <div class="space-y-4">
          ...
          <p>
            At <span class="font-bold text-secondary">Qualiscent Infotech LLP</span>, we specialize in developing high-performance, scalable software solutions that are custom-built to meet your unique business needs and challenges.
          </p>
        </div>
      </div>`,
      secondSection: `<div class="py-6">
        <div class="space-y-6">
          <h2 class="text-xl font-bold">
            Why Choose Qualiscent Infotech LLP for Software Development?
          </h2>
          <ul class="space-y-5 list-decimal pl-6">
            <li>
              <h3 class="font-bold mb-2">Custom Solutions</h3>
      ...
      thirdSection: `<div class="py-6">
        <div class="space-y-6">
          ...
          <p>
            At Qualiscent Infotech LLP, we combine technical expertise with business acumen to deliver software solutions that drive growth and efficiency.
          </p>
          <ul class="space-y-5 list-disc pl-6">
            <li>
  ...
  },
  {
    ...
    icon: icon5,
    desc: "Navigate the digital landscape with confidence using Qualiscent Infotech LLP’s IT consultancy and strategy services. We provide expert guidance to align technology with your business goals and drive sustainable growth.",
    detailsPage: {
      ...
      firstSection: `
        <div class="space-y-6">
          <div class="space-y-4">
            ...
            <p>
              At <span class="font-bold text-secondary">Qualiscent Infotech LLP</span>, we work closely with your team to understand your unique needs, analyze current systems, and design a strategic roadmap that drives digital transformation and business growth.
            </p>
          </div>
        </div>
      `,
      secondSection: `
        <div class="py-6">
          <div class="space-y-6">
            <h2 class="text-xl font-bold">
              Why Choose Qualiscent Infotech LLP for IT Consultancy?
            </h2>
            <ul class="space-y-5 list-decimal pl-6">
              <li>
  ...
  },
  {
    ...
    icon: icon6,
    desc: "Optimize your IT operations with Qualiscent Infotech LLP’s comprehensive infrastructure management services. We ensure seamless, secure, and scalable solutions that support your business’s evolving needs.",
    detailsPage: {
      ...
      firstSection: `
        <div class="space-y-6">
          <div class="space-y-4">
            ...
            <p>
              Qualiscent Infotech LLP’s IT Infrastructure Management services are designed to ensure your business operates at peak efficiency. From data center management to network support, we handle the complexities of infrastructure, allowing you to focus on growth and innovation.
            </p>
            <p>
      ...
      secondSection: `
        <div class="py-6">
          <div class="space-y-6">
            <h2 class="text-xl font-bold">
              Why Choose Qualiscent Infotech LLP for IT Infrastructure Management?
            </h2>
            <ul class="space-y-5 list-decimal pl-6">
              <li>
